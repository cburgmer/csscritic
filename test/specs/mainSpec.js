describe("Main", function () {
    ...
    beforeEach(function () {
        reporting = jasmine.createSpyObj("reporting", [
            "doReportConfiguredComparison",
            "doReportComparison",
            "doReportTestSuite",
        ]);
    ...
    describe("adding & executing", function () {
        ...
        it("should result in success", function (done) {
            ...
            csscritic.execute().then(function (success) {
                ...
                expect(util.hasTestSuitePassed).toHaveBeenCalledWith([
                    comparison,
                ]);
    ...
    describe("Filtering", function () {
        ...
        it("should make filtering optional", function (done) {
            var main = csscriticLib.main(regression, reporting, util, storage);
