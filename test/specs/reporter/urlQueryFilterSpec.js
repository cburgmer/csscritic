describe("Url Query Filter", function () {
    ...
    describe("selection by test case", function () {
        it("should provide a filter url", function () {
            ...
            expect(urlQueryFilter.filterUrlFor({ url: "aUrl.html" })).toEqual(
                "?filter=aUrl.html"
            );
        });
        ...
        it("should respect existing parameters", function () {
            ...
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
            expect(urlQueryFilter.filterUrlFor({ url: "aUrl.html" })).toEqual(
                "?some=other&val=ues&filter=aUrl.html"
            );
        });
        ...
        it("should deal with duplicate filter parameter", function () {
            windowLocation.search =
                "?some=other&filter=something&val=ues&filter=someMore";
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
            expect(urlQueryFilter.filterUrlFor({ url: "aUrl.html" })).toEqual(
                "?some=other&val=ues&filter=aUrl.html"
            );
        ...
        it("should provide a filter url for description if available", function () {
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
            expect(
                urlQueryFilter.filterUrlFor({ desc: "a description" })
            ).toEqual("?filter=a%20description");
        });

        it("should provide a filter url for description and component if available", function () {
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
            expect(
                urlQueryFilter.filterUrlFor({
                    component: "the component",
                    desc: "a description",
                })
            ).toEqual("?filter=the%20component%20a%20description");
        });
    });
    ...
    describe("selection by component", function () {
        it("should provide a filter url", function () {
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
            expect(
                urlQueryFilter.filterUrlForComponent("the component")
            ).toEqual("?filter=the%20component");
        });
    });
    ...
    describe("clearing", function () {
        ...
        it("should deal with duplicate filter parameters", function () {
            windowLocation.search =
                "?some=other&filter=something&val=ues&filter=aSelection";
            var urlQueryFilter = csscriticLib.urlQueryFilter(windowLocation);
    ...
    describe("filtering", function () {
        ...
        it("should not filter if no query given", function () {
            ...
            expect(urlQueryFilter.isComparisonSelected(firstComparison)).toBe(
                true
            );
        });
        ...
        it("should match last filter value", function () {
            ...
            expect(urlQueryFilter.isComparisonSelected(secondComparison)).toBe(
                true
            );
        });
        ...
        it("should match for a description and component", function () {
            var comparison = aComparisonWithDescription(
                "a description",
                "the component"
            );
